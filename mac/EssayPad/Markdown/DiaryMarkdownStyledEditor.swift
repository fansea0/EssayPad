...
final class DiaryMarkdownTextView: NSTextView {
...
struct DiaryMarkdownStyledEditor: NSViewRepresentable {
    var text: String
    ...
    func makeNSView(context: Context) -> NSScrollView {
        ...
        let textView = DiaryMarkdownTextView(frame: NSRect(x: 0, y: 0, width: 600, height: 0))
        ...
        applyDiaryMarkdownStyles(to: textView)
    ...
    final class Coordinator: NSObject, NSTextViewDelegate {
        ...
        func textDidChange(_ notification: Notification) {
            ...
            let work = DispatchWorkItem { [weak textView] in
                ...
                applyDiaryMarkdownStyles(to: tv)
                var boldChars = 0
                var monoChars = 0
                var italicChars = 0
                var fadedChars = 0
...
func applyDiaryMarkdownStyles(to textView: NSTextView) {
